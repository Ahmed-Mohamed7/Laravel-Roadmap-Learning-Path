...
| Topic | Learning Links |
| ----- | ----- |
| **Routing Advanced** :+1:| :clapper: [Laravel: 8 Tips for Advanced Routing](https://www.youtube.com/watch?v=_BIhuX8owTo) <br> :clapper: [More videos](videos/routing-advanced.md) <br> |
